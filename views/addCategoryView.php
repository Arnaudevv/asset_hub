    ...
    <div class="container-fluid form-header">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2 mb-2">
            <div class="x">
                ...
                <p class="text-muted mb-0">Create and register a new category for your inventory.</p>
            </div>
        </div>
                ...
                <div class="col-12 col-xl-7 d-flex">
                    <div class="card premium-form-card w-100 border-0">
                        ...
                        <div class="card-body-custom">
                            <form action="index.php?action=createCategory" method="POST" id="category-form">

                                <!-- Long name: used internally as a slug (e.g. "computers") -->
                                ...
                                <!-- Display name: shown in the UI (e.g. "Computers & Laptops") -->
                                <div class="premium-field-group">
                                    <label class="premium-field-label">
                                ...
                                <!-- Color and emoji pickers side-by-side.
                                     The visible UI elements write their selected values into the hidden inputs,
                                     which are the actual fields submitted with the form. -->
                                <div class="row g-3">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="premium-field-group mb-0">
                                            ...
                                            <input type="hidden" name="color" id="input-color" value="rgba(15, 98, 254, 0.12)" required>
                                            <div class="color-picker-grid" id="color-picker-grid"></div>
                                            <div class="color-preview-row">
                                                <span class="color-preview-dot" id="color-preview-dot"></span>
                                                <span class="color-preview-label" id="color-preview-label">rgba(15, 98, 254, 0.12)</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="premium-field-group mb-0">
                                            ...
                                            <input type="hidden" name="icon" id="input-icon" value="📦" required>
                                            <div class="emoji-picker-grid" id="emoji-picker-grid"></div>
                                            <div class="emoji-preview-row">
                                                <span class="emoji-preview-current" id="emoji-preview-current">📦</span>
                                ...
                                <button type="submit" class="premium-btn-submit">
                                    <i class="bi bi-plus-circle-fill"></i> Register Category
                                </button>
...
<script>
    ...
    COLOR_PALETTE.forEach((color, index) => {
        ...
        swatch.addEventListener('click', () => {
            ...
            // Update hidden input and preview indicator
    ...
    // Initialise color dot with the default selection
